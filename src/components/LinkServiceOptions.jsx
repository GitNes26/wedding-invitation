...
const LinkServiceOptions = ({
   ...
   const services = {
      calendar: {
         ...
         Outlook: `https://outlook.live.com/calendar/0/deeplink/compose?path=/calendar/action/compose&rru=addevent&subject=Boda&startdt=${weddingDate}&location=${weddingPlace}`,
      },
      maps: {
         "Google Maps": mapsUrl,
